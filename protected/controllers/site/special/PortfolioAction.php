...
class PortfolioAction extends CAction{
    ...
    public function listar($isCategoria = false){
        ...
        try{
            $data = HelperUtils::getPageBundle(C::PORTFOLIO);
            ...
            $this->controller->render("/site/pages/portfolio/portfolio_simples/main", $data);
        
        }catch(CDbException $e) {
            Yii::trace("ERROR ".$e->getMessage());
            echo 'ERROR: PortfolioAction - listra() ' . $e->getMessage();
        }
    }
    ...
    public function detalhes($id){
        ...
        try{            
            ...
            Yii::trace("ERROR ".$e->getMessage());
            echo 'ERROR PortfolioAction - detalhes() ' .$e->getMessage();
        }
    }
