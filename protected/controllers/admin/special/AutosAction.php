...
class AutosAction extends CAction{
    ...
    public function run(){
        ...
        Yii::import('application.extensions.dbuzz.admin.AutosManager');
    ...
    public function listar($isCategoria = false){
        ...
        try{
            ...
            if($session['acess_level'] == 4) $data['content'] = $this->autosHandler->getAllContent(true, "todos", 0, $start);
            if($session['acess_level'] == 1) $data['content'] = $this->autosHandler->getAllContent(true, "owner", $session['id'], $start);
            ...
            $data['paginacao'] = MethodUtils::getPaginationAttributes($data, C::AUTOS_ADMIN);
            $data['id_page'] = $this->nr_page;

            $data['categorias'] = $this->categorias->getAllProductCategories(4);
            ...
            //Load tips
            $data['dicas'] = DicasUtils::getTips(C::GENERAL, C::AUTO); 
            $data['tipo'] = $this->id;

            $data['preferences']['design_site'] = C::VAR_EMPTY;            
         
            $data['session'] = MethodUtils::getSessionData(); 
            $data['sidemenu'] = HelperUtils::adminUtils('autos', array('extra' => 'item', 'action' =>'listar', 'tipo' =>'listar'));       
            
            $this->addScript("listar");
            $this->controller->layout = "admin/admin";
            $this->controller->render("/admin/pages/autos/listar", $data);           
    ...
    public function novo($action){
        ...
        try{
            ...
            if($action == 'editar') $result['content'] = $this->autosHandler->getContentById($id_produto, "editar");
            ...
            //Autos
            $data['ano'] = $result['content']['ano'];
            $data['modelo'] = $result['content']['modelo'];
            $data['combustivel'] = $result['content']['unidade'];
            if($result['content']['modelo'] != '') $data['modelo_veiculos'] = $this->autosHandler->getModelos();
            ...
            $data['categorias_paginas'] = $this->categorias->getAllContentById(4);//TODO replace this hard-coded

            $data['session'] = MethodUtils::getSessionData(); 
            $data['sidemenu'] = HelperUtils::adminUtils('autos', array('extra' => 'item', 'action' => 'novo'));
            
            //Form Parameters
            $data['FORM_SUBMIT_TO'] = '/admin/auto/salvar';
            $data['preferences']['design_site'] = "empty";
            
            $this->addScript("editar");
            $this->controller->layout = "admin/admin";           
            $this->controller->render("/admin/pages/autos/novo", $data);
    ...
    private function salvar(){
        ...
        try{
            ...
            if ($isPostRequest){
                ...
                //Autos
                if(isset($_POST['ano'])) $produto->ano = $_POST['ano']; 
                if(isset($_POST['modelo']))$produto->modelo = $_POST['modelo'];
                ...
                $produto->unidade = $_POST['combustivel'];
                ...
                if(isset($_POST['produtos_exibe'])){$produto->exibe_produtos = MethodUtils::getBooleanNumber($_POST['produtos_exibe']);}
    ...
    public function remover(){
        ...
        try{
            $this->autosHandler->removeContent($id_produto);
    ...
    public function removerImage(){
        ...
        try{
            $this->autosHandler->removeImage($id_produto, $id_image, $name_image);
    ...
    public function updateStatus(){
        ...
        $update = $this->autosHandler->updateStatus($data);        
        echo $update;
    }
    ...
    public function loadModelos(){
        ...
        try{
            ...
            $result['view'] = $this->controller->render("/admin/pages/autos/content/item_modelos", $content, true);
            echo json_encode($result);
    ...
    public function exibirOrder() {
        ...
        try { 
            ...
            $result['content'] = $this->autosHandler->getContentByIdType(null, 'ordem_servico', $result['ind']);
            ...
            $this->controller->render("/admin/pages/autos/exibir_order", $result);
    ...
    public function adicionarItems() {
        ...
        try {   
            $result = array();
            $this->controller->layout = 'admin/admin_base';
            $this->controller->render("/admin/pages/autos/adicionar_item", $result);
    ...
    public function adicionar(){
        ...
        try{            
            ...
            $this->controller->layout = "admin/admin_base";
            $this->controller->render("pages/autos/categorias/categorias_adicionar", $result);
    ...
    public function subAdicionar(){
        ...
        try{            
            $result['id_page'] = $this->id;
            $result['categorias']   = $this->categorias->getAllProductCategories(4);          
            $result['content']['id_page'] = $this->id;
            ...
            $this->controller->layout = "admin/admin_base";
            $this->controller->render("pages/autos/categorias/categorias_adicionar_sub", $result);
    ...
    public function novoCategoria(){
        ...
        try{            
            ...
            if(isset($result['categorias'][0]['id_categoria'])){
                $result['subcategorias'] = $this->categorias->getAllProductSubCategories($result['categorias'][0]['id_categoria'], false, 4);
            }else{
            ...
            $this->controller->render("pages/autos/categorias/categorias_novo", $result);
    ...
    public function listarCategoria(){
        ...
        try{
            $result['categorias'] = $this->categorias->getAllProductCategories(4);
            $result['subcategorias'] = $this->categorias->getAllProductSubCategories("", true, 4);
            $result['subitems'] = $this->categorias->getSubItemsEcommerce("", true, 4);
            ...
            $this->addScriptCategorias();
            $this->controller->layout = "admin/admin2";
            $this->controller->render("pages/autos/categorias/categorias_listar", $result);
    ...
    public function comentarios($status = 0){  
        ...
        try{
            ...
            $result['session'] = MethodUtils::getSessionData(); 
            $result['sidemenu'] = HelperUtils::adminUtils('autos', array('extra' => 'comentarios', 'action' => 'listar'));
    ...
    public function detalhes(){
        ...
        try{            
            ...
            $result['session'] = MethodUtils::getSessionData(); 
            $result['sidemenu'] = HelperUtils::adminUtils('autos', array('extra' => 'detalhes', 'action' => 'detalhes'));       
            $result['dicas'] = DicasUtils::getTips("stock", "produtos");
    ...
    public function addScript($place){
        ...
        if($place != "listar"){
            ...
            $cs->registerScriptFile($baseUrl . '/js/admin/autos.js', CClientScript::POS_BEGIN);
    ...
    public function addScriptCategorias(){
        ...
        $cs->registerScriptFile($baseUrl . '/js/admin/autos.js', CClientScript::POS_END);
