...
class JsonSiteUtils {
    ...
    */
    ...
    /**
     * Método para atualizar o CSS Editor
     *
     * @param string
     *
    */
    public static function updateCSSEditor(){
        ...
        try{
            ...
            $dados = PreferencesUtils::getAttributes('css_editor_code', 'descricao');

            //*******************//
     
            $cria = fopen("media/user/css/client.css", "w+");             
            $escreve = fwrite($cria, utf8_encode("$dados"));            
