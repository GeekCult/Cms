                ...
                <td class="container" style="margin: 0 auto!important;padding: 0;display: block!important;clear: both!important; " align="center">
                    ...
                    <div class="content" style="margin: 0 auto!important;display: block; width: 600px!important;">
                        ...
                        <table width='100%' border='0' align='center' cellpadding='2' cellspacing='4' style="border: 1px solid #e9e9e9">
                            ...
                            <tr>
                                <td>
                                    <div style="margin-left: 10px;"><b>Olá</b>,</div>
                                </td>
                            </tr>                            
                            <tr>
                                <td>
                                    <div style="margin-left: 10px;"><p>Nova consulta de preço</p></div>
                                </td>
                            </tr>
                            <tr>
                                <td><br/></td>
                            ...
                            <tr>
                                <td>
                                    <table style="width:100%; border: 1px solid #999; padding: 10px">
                                        <tr  style="background:#333; color: #fff; border-bottom: 1px solid #333;">
                                            <td style="color: #fff; font-weight: bold; padding: 10px" colspan="2">Dados</td>
                                        </tr>
                                        <tr style="background:#fcfcfc; border-bottom: 1px solid #333;">
                                            <td style="color: #000; font-weight: bold; padding: 10px" width="90">Nome </td>
                                            <td style="color: #333; padding: 10px; font-size: 14px"><?php echo $nome ?></td>
                                        </tr>
                                        <tr style="background:#fcfcfc; border-bottom: 1px solid #333;">
                                            <td style="color: #000; font-weight: bold; padding: 10px" width="90">E-mail </td>
                                            <td style="color: #333; padding: 10px; font-size: 14px"><?php echo $email ?></td>
                                        </tr>
                                        <tr style="background:#fcfcfc; border-bottom: 1px solid #333;">
                                            <td style="color: #000; font-weight: bold; padding: 10px" width="90">Telefone </td>
                                            <td style="color: #333; padding: 10px; font-size: 14px"><?php echo $telefone ?></td>
                                        </tr>
                                        <tr style="background:#fcfcfc; border-bottom: 1px solid #333;">
                                            <td style="color: #000; font-weight: bold; padding: 10px" width="90">Cidade</td>
                                            <td style="color: #333; padding: 10px; font-size: 14px"><?php echo $cidade . ' - ' . $estado ?></td>
                                        </tr>
                                        <?php if($empresa != '' || $cnpj != ''){ ?>
                                        <tr style="background:#fcfcfc; border-bottom: 1px solid #333;">
                                            <td style="color: #000; font-weight: bold; padding: 10px" width="90">Empresa </td>
                                            <td style="color: #333; padding: 10px; font-size: 14px"><?php echo $empresa; if($cnpj != '') echo ' - ' . $cnpj ?></td>
                                        </tr>
                                        <?php } ?>
                                    </table>
                                </td>
                                ...
                                <td align="center">
                                    <table style="width:100%; border: 1px solid #999; padding: 10px">
                                        <tr style="background: #333">
                                            ...
                                            <td style="width: 70px; color: #fff; font-weight: bold;padding: 10px">Valor</td>
                                        </tr>
                                        ...
                                        <tr style="background: #f9f9f9">
                                            ...
                                            <td style="width: 70px; color: #333; font-weight: bold;padding: 10px"><?php echo $values['valor_string'] ?></td>
                                        </tr> 
                                        <?php } } ?>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <table style="width:100%; border: 1px solid #999; padding: 10px">
                                        <tr  style="background:#333; color: #fff; border-bottom: 1px solid #333;">
                                            <td style="color: #fff; font-weight: bold; padding: 10px">Mensagem</td>
                                        </tr>
                                        <tr style="background:#fcfcfc; border-bottom: 1px solid #333;">
                                            <td style="color: #333; padding: 10px; font-size: 14px"><p><?php echo nl2br($message) ?></p></td>
                                        </tr>                                       
                                    </table>
                                </td>
                            </tr>
