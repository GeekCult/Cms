    ...
    <div class="container pan">
        <div class="pan_shadow">
            <div class="mgL mgR">
                ...
                <div class="row-fluid">
                    <h2 class="titulo">Detalhes do veículo</h2>
                    <hr class="half" />
                    ...
                    <div class="container_item_produto hProduct" id="container_produto_<?php echo $content['id'] ?>">
                        ...
                        <div class="span6">
                            ...
                            <div class='clear'></div>
                            <?php if(isset($content['tags']) && true == false){ ?>
                            <div class="ctnTags">
                        ...
                        <div id="my-tab-content" class="tab-content">
                            <div class="tab-pane active" id="descricao">
                                <div class="span12">
                                    ...
                                    <p class="align_left lead"><?php if($content['descricao'] != ''){echo nl2br($content['descricao']);} else {echo Yii::t('siteStrings', 'no_items_to_be_shown');} ?></p>
                                    <p>&nbsp;</p>
                            ...
                            <div class="tab-pane" id="videos">
                                <div class="span12">
                                    ...
                                    <p class="align_left"><?php if(isset($content['video1']['big']) && $content['video1']['big'] != ''){echo $content['video1']['big'];}else{echo Yii::t('siteStrings', 'no_items_to_be_shown');} ?></p>
                                    <p>&nbsp;</p>
                                    <div class="divider_shadow"></div>
                                    <p>&nbsp;</p>
                                </div>
...
<input type="hidden" id="helper_tipo" value="auto"/>
