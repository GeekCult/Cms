...
<!-- CONTENT CONTAINER-->
<!-- ################ -->
<div class="container pan" data-template="horizontal_banner_html5">
    <div class="mgL mgR">
        ...
        <div class="mgL mgR">
            ...
            <div class="span11 center">
                <?php if ($graphics['container_1'] ) { if($graphics['container_1']['slot_type'] == "f"){ ?>                       
                 ...
                 <?php  }else{ ?>
                    <?php if(isset($graphics['container_1']['embeded_original']))echo $graphics['container_1']['embeded_original'] ?>                  
                 <?php  } } ?>
            </div>
            <!-- END IMAGE -->
        ...
        <div class="mgL mgR">
            ...
            <div class="span11 center">
                <?php if ($graphics['container_2'] ) { if($graphics['container_2']['slot_type'] == "f"){ ?>                       
                 ...
                 <?php  }else{ ?>
                    <?php if(isset($graphics['container_2']['embeded_original']))echo $graphics['container_2']['embeded_original'] ?>
                <?php  } } ?>
            </div>
            <!-- END IMAGE -->
