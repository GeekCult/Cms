<div id="texas_hold_<?php echo $id ?>" class="fullCP">
    ...
    <div class="row-fluid">
      <div class="<?php if((isset($is_container) && !$is_container) || !isset($is_container)) echo 'container' ?> fullCT">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="view <?php if(isset($extra['composite_layout_1']) && $extra['composite_layout_1'] != ''){echo $extra['composite_layout_1'];}else{echo "view-eighth";} ?>">
                        ...
                        <?php if($link_1 != ''){ ?></a><?php } ?>
                        <div class="mask">
                            <?php if(isset($extra['composite_titulo_exibe_1']) && $extra['composite_titulo_exibe_1']){ ?><h2 class="tItem"><?php if(isset($extra['composite_titulo_1'])){ echo htmlspecialchars_decode($extra['composite_titulo_1']);} ?></h2><?php } ?>
                            <?php if(isset($extra['composite_texto_exibe_1']) && $extra['composite_titulo_exibe_1']){ ?><p class="dItem"><?php if(isset($extra['composite_texto_1'])){ echo htmlspecialchars_decode(nl2br($extra['composite_texto_1']));} ?></p><?php } ?>
                            <?php if(isset($extra['composite_botao_exibe_1']) && $extra['composite_botao_exibe_1']){ ?><a href="<?php echo $link_1 ?>" <?php if(isset($link_target_1)) echo " target='$link_target_1'"; ?> class="info"><?php if(isset($extra['composite_label_botao_1']) && $extra['composite_label_botao_1'] != ''){ echo $extra['composite_label_botao_1'];}else{echo "Saiba mais";} ?></a><?php } ?>
                        </div>
                    </div> 
                    <p>&nbsp;</p>
                </div>
