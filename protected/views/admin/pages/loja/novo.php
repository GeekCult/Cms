...
<div class="container_pan">
    ...
    <a href="/admin/loja/categorias_listar" id="bt_list">
...
<input type="hidden" value="<?php echo $tipo ?>" id="helper_tipo"/>
<script type="text/javascript">initLojaCategoriasListeners(); updatePanMain();</script>
