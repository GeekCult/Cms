<div class="container_pan">
    <div class="titleContent">
        <div class="titlePageAdmin">
            <h1><?php echo Yii::t("adminForm", "user_page_title_list")  . ": " . $type ?></h1>
        </div>
    ...
    <div id="ItemManager">
        <div class="table_support">            
            <table border="0" align="center" cellpadding="1" cellspacing="2" width="100%">
                ...
                <tr class="title_table">
                    ...
                    <td width="10%" align="center" class="title_table"><strong><?php echo Yii::t("adminForm", "title_common_date") ?></strong></td>
                ...
                <tr id="obj_container_<?php echo $values['id'] ?>" class="rows_table_<?php echo $color ?>">
                    <td align="center"><img alt="" src="/media/images/icons/icon_mais.png" width="20" height="20" /></td>
                    <td><?php if($values['type'] == 1){echo  $values['field1'];} else{ echo  $values['field1'] . " " . $values['field2'];} ?></td>
                    <td align="center"><?php echo $values['name'] ?></td>
                    <td><?php echo $values['email'] ?></td>
                    <td align="center"><?php echo $values['creation'] ?></td>                   
        ...
        <p>&nbsp;</p>
        <div class="container_qtd_users"><b>Quantidade total de usuários:</b> <?php echo $qtd_cat ?></div>
    </div>
    <div class="clear"></div>
...
<script type="text/javascript">setTimeout(function(){initLiveSearchUserKindOf(); initListenerUsersTags();},1000);</script>