<div class="container_pan">
    <div class="titleContent">
        <div class="titlePageAdmin">
            <h1><?php echo Yii::t("adminForm", "settings_ecommerce_page_title_see") ?></h1>
        </div>
        <div class="bug_tracker iframe"></div>
    </div>
    <a href="/admin/loja/categorias_listar">
        <input type="button" class="bt_right" value="<?php echo Yii::t("adminForm", "button_common_list") ?>" />
    </a>
    <a href="/admin/loja/categorias_novo">
        ...
        <ul class="container_item_page">
            ...
            <li class="rows">
                ...
                <div class="menus_support">
                    ...
                    <div class="menu_checkbox">
                        <div class="menu_checkbox_label">exibir</div>
...
<script type="text/javascript">initCategoriasEcommerceList();</script>
