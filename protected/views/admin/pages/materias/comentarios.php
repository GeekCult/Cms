<div class="container_pan">
    ...
    <a href="<?php if($tipo != 'depoimentos'){ ?>novo<?php }else{ ?>novo_depoimento<?php } ?>">
    ...
    <div class="comboboxSelector_double">
        <div class="container-combobox-cat_double">
            <a href="/admin/materias/comentarios_aprovados" id="bt_aprovados" class="<?php if($status == 1) echo 'a_focus' ?>"><?php echo Yii::t("adminForm", "title_common_approved"); ?></a>
            <label>|</label>
            <a href="/admin/materias/comentarios" id="bt_esperando" class="<?php if($status == 0 || $status == '') echo 'a_focus' ?>"><?php echo Yii::t("adminForm", "title_common_wait_approved"); ?></a>
        </div>
    </div>
    <div id="ItemManager">
        <div class="table_support">            
            <table border="0" align="center" cellpadding="2" cellspacing="4" width="100%">                
                ...
                <tr id="obj_container_<?php echo $values['id'] ?>" class="rows_table_<?php echo $color ?>">
                    ...
                    <td><div class="truncate"><?php echo $values['info']['titulo'] ?></div></td>
