            ...
            <div id="image_support">
                <div class='imageFotos'>
                    <div class='containerFotos'>
                        <img src="/media/images/user/thumbs_120/<?php echo $values['foto'] ?>" alt="" title="<?php echo $values['titulo'] ?>"/>
                    ...
                    <div class='excluirFotos'>
                        ...
                        <div class='bt_editarFotos'>
                            <a class='fancybox' title="<?php echo $values['titulo'] ?>" href="/media/images/user/original/<?php echo $values['foto'] ?>">
