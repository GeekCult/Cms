        ...
        <form id="form_banner_render">
            ...
            <div id="holdTab_1" class="ctnTbsRender">
                <ul id="slot_support">            
                    ...
                    <li class="rows">
                        <div class="label_text_Admin">Chamada - título</div> 
                        <input type="input" class="input_big" name="chamada_titulo" value="<?php if(isset($content['cool2']['preferences']['rodape']['attr']['chamada_titulo'])) echo $content['cool2']['preferences']['rodape']['attr']['chamada_titulo'] ?>" class="mgR"/>
                        
                        <div class="clear mgB"></div>
                        <div class="label_text_Admin">Chamada - texto</div> 
                        <input type="input" class="input_big" name="chamada_texto" value="<?php if(isset($content['cool2']['preferences']['rodape']['attr']['chamada_texto'])) echo $content['cool2']['preferences']['rodape']['attr']['chamada_texto'] ?>" class="mgR"/>
                    ...
                    <li class="rows">
                        ...
                        <input type="input" class="input_big" name="titulo1" value="<?php if(isset($content['cool2']['preferences']['rodape']['attr']['titulo_column_1'])) echo $content['cool2']['preferences']['rodape']['attr']['titulo_column_1'] ?>" class="mgR"/>
                        <div class="clear mgB0"></div>
                        <div class="label_text_Admin">Textos</div>       
                        <div class="ctnTextarea">
                            <textarea id="texto1" name="texto1" rows="4" class="textarea_big"><?php if(isset($content['cool2']['preferences']['rodape']['attr']['texto_column_1'])) echo $content['cool2']['preferences']['rodape']['attr']['texto_column_1'] ?></textarea>
                        </div>
                        
                        <div class="clear mgB0"></div>
                        <div class="label_text_Admin">Link</div> 
                        <input type="input" class="medium" name="link1" value="<?php if(isset($content['cool2']['preferences']['rodape']['attr']['link_column_1'])) echo $content['cool2']['preferences']['rodape']['attr']['link_column_1'] ?>" class="mgR"/>
                        <div class="clear mgB0"></div>
                    </li>
