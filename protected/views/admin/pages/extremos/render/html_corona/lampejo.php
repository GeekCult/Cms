...
<div class="container_pan">
    ...
    <div class="ctnFullBanner" style="<?php if($content['image'] != ''){if($content['image_type'] == 0){echo "background: url(/media/user/images/original/". $content['image'] .") center center";}else{echo "background: url(/media/images/textures/site/". $content['image'] .") center center";}} ?>; min-height: 100px">
        <div class="ctnBannerRender">
            <div class="html_corona">
        ...
        <form id="form_banner_render">
            <div id="holdTab_1" class="ctnTbsRender">
                <ul id="slot_support">            
                    ...
                    <li class="rows">
                        <div class="label_text_Admin">Nome do banner</div>
                        <div class="text">
                            <input id="nome_banner" name="nome_banner" class="input_big" value="<?php echo $content['nome'] ?>" placeholder="Nome para fácil identificação na listagem">
                        </div>
                    ...
                    <li class="rows">
                        ...
                        <div class="text">
                            <input id="titulo_banner" name="titulo_banner" class="input_big" value="<?php echo $content['titulo'] ?>" placeholder="Título para exibição no site">
                        </div>
                        <div class="clear mgB"></div>
                    </li>
                    <li class="rows">
                        ...
                        <div class="text">
                            <textarea id="descricao_banner" name="descricao_banner" class="textarea_big" placeholder="Descrição do banner"><?php echo $content['descricao'] ?></textarea>
                        </div>
                        <div class="clear mgB"></div>
                    </li>
                    <li class="rows">
                            ...
                            <div class="column_settings_banners_left" id="slot_support">
                                ...
                                <div class="container_slot" id="4">
                                    ...
                                    <div class="slot_launcher slot_page" id="slot_page_4">
                                        ...
                                        <script type="text/javascript">applyPictureSize('<?php echo $content['cool2']['image1']['src'] ?>', 4, 'image', true);</script>
                                        <?php } ?>
                                    </div>
                                ...
                                <div class="container_info_view">
                                    ...
                                    <div class="texto_column_info">
                                        ...
                                        <div class="topic info_text_line">Tamanho ideal da imagem 300x240px</div>
