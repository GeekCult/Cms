...
<div class="ctnItemAdv">
    <div class="ctnImgAdv mgB">
        <img id="mainBlockItem"src="https://www.purplepier.com.br/media/images/layout_block/<?php echo $blocks[$i]['thumb'] ?>" alt="<?php echo $blocks[$i]['thumb'] ?>" />
    </div>
...
<div class="ctnBt_aplly">
    <input type="button" class="botao bt_apply_block" id="bt_aplicar_component" value="aplicar" data-id_page="<?php echo $id_page ?>" data-id_component="<?php echo $blocks[$i]['id'] ?>"/>
</div>
...
<div class="ctnItemAdvThumbs" data-id_item="<?php echo $blocks[$i]['id'] ?>" data-titulo="<?php echo $blocks[$i]['titulo'] ?>" data-descricao="<?php echo $blocks[$i]['descricao'] ?>" data-image="<?php echo $blocks[$i]['thumb'] ?>">
    <div class="ctnImgAdv mgB">
        <img src="https://www.purplepier.com.br/media/images/layout_block/<?php echo $blocks[$i]['thumb'] ?>" alt="<?php echo $blocks[$i]['thumb'] ?>" width="220" height="67"/>
    </div>
