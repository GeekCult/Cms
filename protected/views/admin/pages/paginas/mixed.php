<div class="ctnBlockTemplates">
    ...
    <div class="clear"></div> 
    <?php $query_allowed = $content['tipo'] != 'vazio' && $content['tipo'] != '' && $content['tipo'] != 'home' && $content['tipo'] != 'intro' && $content['tipo'] != 'contato' && $content['tipo'] != 'elearn' && $content['tipo'] != 'termos' && $content['tipo'] != 'redebeneficios' && $content['tipo'] != 'colunas' && $content['tipo'] != 'politica_privacidade' && $content['tipo'] != 'termos'  && $content['tipo'] != 'agenda'; ?>
</div>
    ...
    <fieldset class="adminFormContent">
        ...
        <ul class="container_item_page">
                    ...
                    <div class="text">
                        <div class="styled-select2">
                            <select id="type_layout" size="1" name="type_layout">                                
                                ...
                                <option value="2" selected>Mix</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <li class="rows_template">
                <div class="ctn_carousel_template">
                    ...
                    <div id="ctn_template_slider">
                        <?php if($templates_paginas[0]['qtd'] > 0){ $i = 0; foreach ($templates_paginas as $values){ $str = substr($values['thumb'], 0, strrpos($values['thumb'], '.')); ?>
                    ...
                    <script type="text/javascript">initListenerModuleNoticiasSlider("<?php echo $templates_paginas[0]['qtd'] ?>");</script>
                </div>
                <div class="clear"></div>
            ...
            <li class="rows <?php if($action == "novo_curso") echo "hide" ?>">
                <div class="label_text_Admin">Keywords:</div>
                <div class="text">
                ...
                <li class="rows">
                    ...
                    <div class="container_banner_pages container_slot" id="0">
                        <div class="base_banner_container" id="base_0">
                            <div class="base_banner_bt_edit" title="Editar cool" id="<?php echo $slots['banner']; ?>"></div>
                            <div class="base_banner_bt_select" title="Selecionar novo cool" id="<?php echo $slots['banner']; ?>"></div>
                        ...
                        <div class="title_slot" id="title_slot_0" id="<?php if($slots['banner']!= "")echo $slots['banner']; ?>"></div>
...
<script type="text/javascript">setEditSlots(<?php echo json_encode($slots) ?>); setLastFieldText(<?php if(isset($content['num'])){echo $content['num'];}else{echo '0';} ?>);</script>
<?php } ?>
