...
<div class="container_pan">
    ...
    <div class="textLayout"><?php echo Yii::t("adminForm", "category_page_label_info") ?></div>
        ...
        <div class="buttons_right">       
            <input type="button" class="bt_right" id="bt_submit_categoria_ecommerce" value="<?php if($action == "novo"){echo Yii::t("adminForm", "button_common_submit");}else{echo Yii::t("adminForm", "button_common_update");} ?>"/>
        </div>
    
    </form>
</div>
<input type="hidden" value="<?php echo $action ?>" id="helper_action" data-tipo="4"/>
