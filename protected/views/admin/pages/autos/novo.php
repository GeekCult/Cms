...
<div class="mainPan">
    <div class="wrap">
        ...
        <div class="bt_rigth_small" title="adicionar novo">
            <a href="/admin/autos/novo" id="bt_new"><?php echo Yii::t("adminForm", "button_common_add") ?></a>
        </div>
                ...
                <ul>
                    ...
                    <li id="link_conta_02"><div class="tab_corner_disable_left"></div>
                        <a id="bt_transportation">
                            <div class="tab_corner_disable_middle">                                            
                                <div class="bt_support">Exibição</div>                                            
                            </div>
                            <div class="tab_corner_disable_right"></div>
                        </a>
                    </li>
                                ...
                                <div id="support_description">
                                    <div class="container_form1">                                    
                                        <div class="cc-main-content-fullway">
                                            ...
                                            <div class="cc-main-content-fullway">
                                                <div id="palavras-chave">
                                                    <div class="label-categoria">Título</div>
                                                    <div><input name="nome" id="nome" class="input_giant" type="text" value="<?php echo $formPoolNome ?>" placeholder="Digite um título, Ex: Pálio Semi-novo"/></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="cc-main-content-fullway">
                                                <div class="container_categoria_product">
                                                    <div class="label-categoria">Marca</div>
                                                    <div class="styled-select">
                                                        <select class="form-control default-select2" id="marca" name="p_marca">
                                                            <?php foreach ($fabricantes as $values){ ?>
                                                            <option value="<?php echo $values['id'] ?>" <?php if($formPoolMarca == $values['id']) echo 'selected'; ?>><?php echo $values['nome'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div id="modelo_loader" class="container_categoria_product">
                                                    <?php if($modelo != ''){ ?>
                                                    <div class="label-categoria">Marca</div>
                                                    <div class="styled-select">
                                                        <select name="modelo" id="modelo" class="form-control default-select2">
                                                            <?php foreach($modelo_veiculos as $values){ ?>
                                                            <option value="<?php echo $values['id'] ?>" <?php if($modelo == $values['id']) echo 'selected'; ?>><?php echo $values['nome'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                    <?php } ?>
                                            ...
                                            <div class="container_valor">
                                                ...
                                                <div class="container_detalhes">
                                                    <div class="container_price">
                                                        <input name="valor_real" id="valor_real" class="input_small0" type="text" value="<?php echo $formPoolValorReal; ?>"/> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="container_valor">
                                                <div class="label-categoria">Ano</div>
                                                <div class="container_detalhes">
                                                    <div class="container_price">
                                                        <input name="ano" id="ano" class="input_mini left" type="text" value="<?php echo $ano; ?>"/> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="container_valor">
                                                <div class="label-categoria">Combustível</div>
                                                <div class="styled-select">
                                                    <select name="combustivel" id="combustivel" class="form-control">
                                                        <option value="0" <?php if($combustivel == ''){echo "selected";}?>>Selecione</option>
                                                        <option value="1" <?php if($combustivel == '1'){echo "selected";}?>>Gasolina</option>
                                                        <option value="2" <?php if($combustivel == '2'){echo "selected";}?>>Álcool</option>
                                                        <option value="3" <?php if($combustivel == '3'){echo "selected";}?>>Flex</option>
                                                        <option value="4" <?php if($combustivel == '4'){echo "selected";}?>>Diesel</option>
                                                        <option value="5" <?php if($combustivel == '5'){echo "selected";}?>>Híbrido</option>
                                                        <option value="0" <?php if($combustivel == '0'){echo "selected";}?>>Indiferente</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cc-main-content-fullway">
                                        ...
                                        <table border="0" cellspacing="4" cellpadding="0"  id="cc-contact-form" width="100%">
                                            ...
                                            <tr class="row_table_highlight">
                                                ...
                                                <td>
                                                    <label>
                                                        <input name="produtos_exibe" type="checkbox" value="1" <?php if (isset($produtos_exibe)) if($produtos_exibe == '1') echo "checked"; ?>/> &nbsp;Exibir no site
                                                    </label>
                                                </td>
                                            </tr>
                                            <tr class="row_table_highlight">
                                            ...
                                            <tr class="row_table_highlight hide">
