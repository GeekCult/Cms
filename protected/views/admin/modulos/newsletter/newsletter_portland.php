            ...
            <ul>
                ...
                <li class="rows">
                    <div class="ctnBlcGeral">
                        ...
                        <div class="text">
                            <input id="margin_top" name="margin_top" class="mini2" value="<?php echo $item['content']['margin_top'] ?>" placeholder="10" type="number"/>
                        </div>
                        <div class="clear mgB"></div>
                        <div class="label_text_Admin">Margin - baixo</div>
                        <div class="text">
                            <input id="margin_bottom" name="margin_bottom" class="mini2" value="<?php echo $item['content']['margin_bottom'] ?>" placeholder="10" type="number"/>
                        </div>
                        <div class="clear mgB"></div>
    ...
    <div id="blContainer_1">
        <ul> 
            ...
            <li class="rows">
                ...
                <div class="container_slot_checkbox">
                    <div class="text">
                        <input name="link_1" class="form fM" value="<?php if(isset($item['content']['link_1'])) echo $item['content']['link_1'] ?>"/>
                        <span class="text fS"></span>
                    </div>
                </div>
                <div class="clear"></div>
...
<?php if(isset($item['content']['image_1'])){ ?>
<script type="text/javascript">applyPictureSize('<?php if(isset($item['content']['image_1']['container'])) echo $item['content']['image_1']['container']['foto'] ?>', 3, 'image');</script>
<?php } ?>