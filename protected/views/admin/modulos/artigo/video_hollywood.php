...
<div id="slot_support">
            ...
            <li class="rows">
                ...
                <div class="container_slot_checkbox">
                    <div class="ctn_checkbox">
                        <textarea name="texto_1" rows="3" class="fM"><?php if(isset($item['content']['texto_1'])) echo $item['content']['texto_1'] ?></textarea>
                        <span class="text fS"></span>
                    </div>
                </div>
            </li>
    ...
    <div id="blContainer_2">
        <ul> 
            <li class="rows">
                <div class="ctnRowProp">
                    <div class="txtProp">Incorporar</div>
                </div>
                <div class="container_slot_checkbox">
                    <div class="text">
                        <textarea name="link_1" class="form fM" rows="4"><?php if(isset($item['content']['link_1'])) echo $item['content']['link_1'] ?></textarea>
                        <span class="text fS"></span>
                    </div>
                </div>
            </li>
                    ...
                    <div class="ctnAligment">
                        ...
                        <div class="styled-select left">
                            <select name="layout_1" id="layout_1">
                                <option value="up" <?php if($item['content']['layout_1'] == "up") echo "selected" ?>>Video em baixo</option>
                                <option value="down" <?php if($item['content']['layout_1'] == "down") echo "selected" ?>>Video em cima</option>
                                <option value="left" <?php if($item['content']['layout_1'] == "left") echo "selected" ?>>Video lado direito</option>
                                <option value="right" <?php if($item['content']['layout_1'] == "right") echo "selected" ?>>Video lado esquerdo</option>
                            </select>
                        </div>
                    </div>
